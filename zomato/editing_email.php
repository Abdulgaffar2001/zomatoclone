   	...
   	<div class="row">
   		...
   		<div class="col-md-7" style="margin-left: 300px;margin-top:80px">
   			<h1 class="text-warning"><b>Change Yourself</b></h1>
   			    ...
   			    <form action="change_email.php" method="POST" style="margin-top:50px">
					<label class="text-light" >Old Email</label><br>
					<input type="email" name="old" class="form-control"><br>
					<label class="text-light">New Email</label><br>
					<input type="email" name="new" class="form-control"><br>
					
					<input type="submit" id="submit" name="" class="btn btn-danger text-white " value="Change Email"><br><br>
					</form><br>
					<br><br><br><br>
   		</div>
   	</div>
